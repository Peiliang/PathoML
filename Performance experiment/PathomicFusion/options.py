...
def parse_args():
    ...
    parser.add_argument('--dataroot', default='/home/pxb/code/PathoML/PatchToPathoML', help="datasets")
    parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints/G_sum_1', help='models are saved here')
    ...
    parser.add_argument('--mode', type=str, default='graph', help='mode')
    parser.add_argument('--model_name', type=str, default='praph', help='mode')
    ...
    parser.add_argument('--lr', default=2e-5, type=float, help='5e-4 for Adam | 1e-3 for AdaBound')
